...
public:
   ...
   */
  struct Params {
    size_t ransac_max_iterations = 5; // 新增這行2025,07,30, sw
    /**
    ...
    Eigen::Matrix<double, 3, Eigen::Dynamic> ori_src;
    Eigen::Matrix<double, 3, Eigen::Dynamic> ori_dst;
   ...
   * @param dst
   */
  RegistrationSolution solve( Eigen::Matrix<double, 3, Eigen::Dynamic>& reduce_src,
                              Eigen::Matrix<double, 3, Eigen::Dynamic>& reduce_dst);
